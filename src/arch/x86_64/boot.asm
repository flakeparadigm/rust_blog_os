...
set_up_page_tables:
    ; map first P4 table to P3 table
    mov eax, p3_table
...
; Check for SSE and enable it. If it's no supported throw error "a".
set_up_SSE:
    ; check for SSE
    mov eax, 0x1
    cpuid
    ...
    ; enable SSE
    mov eax, cr0
    and ax, 0xFFB ; clear coprocessor emulation CR0.EM
...
align 4096
p4_table:
    resb 4096 ; asks GRUB to reserve us 4096B memory
p3_table:
    resb 4096
p2_table:
    resb 4096
