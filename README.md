...
This repository contains the source code for my version of the code resulting from the _Writing an OS in Rust_ series at [os.phil-opp.com](http://os.phil-opp.com).
...
## License
The original source code is dual-licensed under MIT or the Apache License (Version 2.0). I have chosen to keep this derivative under the MIT license.
